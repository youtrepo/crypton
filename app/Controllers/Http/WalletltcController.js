    ...
    try {
      ...
      let Transactions=transaction.toJSON()
        ...
        if (check){
          ...
          return view.render('dashboard/walletltc',{wallet:check.address,qr:qrcode,param:request.url(),title:Env.get('TITLE'),transactions:Transactions})
        }else {
          ...
          return view.render('dashboard/walletltc',{wallet:wallet._wallet.receiveAddress.address,qr:qrcode,param:request.url(),title:Env.get('TITLE'),transactions:Transactions})
        }
